...
This script will provision a new machine running a fresh install of [macOS Catalina (10.15)][catalina]. It installs and configures the software, dotfiles, and general preferences I use for web development — primarily [Rails][rails] and [Python][python]. The command line environment is based on [Zsh][zsh], [Neovim][neovim], and [Tmux][tmux] running in [iTerm2][iterm2].
...
&#9657; **Looking for dotfiles only? Check out [My Dotfiles for macOS](http://jbc.dev/dotfiles)**
...
```sh
curl --remote-name https://raw.githubusercontent.com/joelbcastillo/mac-bootstrap/master/bootstrap && sh bootstrap 2>&1 | tee ~/bootstrap.log
```

Want to read through the script first?
```sh
curl --remote-name https://raw.githubusercontent.com/joelbcastillo/mac-bootstrap/master/bootstrap
less bootstrap
...
* Step 2: Set a variety of [macOS defaults][macos-defaults]. (adapted from [https://mths.be/macos][mths])
* Step 3: Install various [executable scripts][exe-scripts] (mostly for Tmux and Git) to `$HOME/bin`.
* Step 4: Set up a default [Tmuxinator][tmuxinator] profile for managing tmux sessions.
* Step 5: Clone [My Dotfiles for macOS][dotfiles] and symlink them to `$HOME` or `$XDG_CONFIG_HOME` as needed.
...
* Remap Caps Lock to ESC (anyone know a way to automate this?)
...
3) Review the 5 steps in [`bootstrap`][bootstrap] and make your own customizations. Here's an overview of what's going on:
...
* Step 2 (required): Review general macOS settings in `install/macos-defaults` and adjust as needed. This script also sets things like `HostName` which are needed later for the dotfiles installation.
* Step 3 (recommended): Install scripts to `~/bin`?
* Step 4 (recommended): Set up Tmuxinator profile?
* Step 5 (required): The dotfiles. Update the `$DOTFILES_*` variables (see [`bootstrap`][bootstrap] under "VARIABLE DECLARATIONS") to reference your dotfiles. As a starting point, you can [fork mine][dotfiles] and then point to your fork.
...
* Kevin Lane (https://github.com/klane/dotfiles/)
...
Copyright &copy; 2020 Joel Castillo. [MIT License](https://github.com/joelbcastillo/mac-bootstrap/blob/master/LICENSE)

[bootstrap]: https://github.com/joelbcastillo/mac-bootstrap/blob/master/bootstrap
[brew-bundle]: https://github.com/Homebrew/homebrew-bundle#usage
[catalina]: https://www.apple.com/macos/catalina/
[dotfiles]: http://github.com/joelbcastillo/dotfiles
[exe-scripts]: https://github.com/joelbcastillo/mac-bootstrap/tree/master/bin
[fish]: http://fishshell.com/
[iterm2]: https://www.iterm2.com/
[laptop]: https://github.com/thoughtbot/laptop
[macos-defaults]: https://github.com/joelbcastillo/mac-bootstrap/blob/master/install/macos-defaults
[mths]: https://mths.be/macos
[my-laptop]: https://github.com/joelbcastillo/mac-bootstrap/blob/master/install/laptop
[neovim]: https://neovim.io/
[prezto]: https://github.com/sorin-ionescu/prezto
[post-install-tasks]: https://github.com/joelbcastillo/dotfiles#post-install-tasks
